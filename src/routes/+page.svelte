...
<!-- <div class="w-full min-h-screen flex flex-col items-center justify-center gap-5">
	<h1 class=" uppercase font-bold flex gap-4 items-center">
		<span
			class="text-slate-100 text-3xl p-3 rounded-lg shadow-md bg-slate-800 border -translate-y-3"
			>Svelte</span
		>
	...
	<span
		class="text-slate-500 text-sm px-3 rounded-full border border-slate-950 border-opacity-25 flex items-center gap-1 capitalize"
		>version <span class="text-xs">
			{version}
		</span></span
	>
	...
	<div class=" w-full md:w-1/2 flex flex-col items-center justify-center">
		<h1 class="text-2xl font-bold my-3">Position</h1>
...
<div
	class="w-full min-h-screen bg-slate-100/10 flex flex-col items-center justify-center gap-5 py-10"
>
